 ...
 * Copyright (c) 2009-2011 by EasyWalk, Inc. All Rights Reserved.
...
//@interface EasyWalkObject : NSObject
//@end

@interface EasyWalkObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[EasyWalkObject class]])
		{
			for (NSString *key in [[(EasyWalkObject*)o modules] allKeys])
			{
