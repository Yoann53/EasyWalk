...
// in simulator we redefine to format for EasyWalk Developer console
...
{\
	NSString * exceptionName = [@"org.easywalk." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.easywalk";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIEasyWalkNativeItemNone = -1, 
	UIEasyWalkNativeItemSpinner = -2,
	UIEasyWalkNativeItemProgressBar = -3,
	
	UIEasyWalkNativeItemSlider = -4,
	UIEasyWalkNativeItemSwitch = -5,
	UIEasyWalkNativeItemMultiButton = -6,
	UIEasyWalkNativeItemSegmented = -7,
	
	UIEasyWalkNativeItemTextView = -8,
	UIEasyWalkNativeItemTextField = -9,
	UIEasyWalkNativeItemSearchBar = -10,
	
	UIEasyWalkNativeItemPicker = -11,
	UIEasyWalkNativeItemDatePicker = -12,
	
	UIEasyWalkNativeItemInfoLight = -13,
	UIEasyWalkNativeItemInfoDark = -14,
	
	UIEasyWalkNativeItemDisclosure = -15,
	
	UIEasyWalkNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all EasyWalk instances of
