...
/**
 The base class for all EasyWalk modules
 */
...
/**
 EasyWalk Platform calls this method on startup.
 */
-(void)startup;

/**
 EasyWalk Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 EasyWalk Platform calls this method on suspend.
 @param sender The sender of the event.
 */
